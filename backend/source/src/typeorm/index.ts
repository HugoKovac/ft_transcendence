...
const entities = [User, Message, Friends, Conv, GroupConv, BanEnity, MuteEntity, GameHistory]

export {User, Message, Friends, Conv, GroupConv, BanEnity, MuteEntity, GameHistory}
