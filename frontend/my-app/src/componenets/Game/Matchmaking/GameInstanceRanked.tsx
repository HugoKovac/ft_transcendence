...
export default function GameInstance()
{
    ...
    const BackToLobby = () =>
    {
        ...
        window.removeEventListener('keydown', Player1keyDownHandler);
        window.removeEventListener('keydown', Player2keyDownHandler);
        window.removeEventListener('keyup', Player1keyUpHandler);
        window.removeEventListener('keyup', Player2keyUpHandler);
        setLobby(null);
